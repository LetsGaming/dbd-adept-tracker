    ...
    >
      ...
      <div class="p-6 space-y-6">
        ...
        <div class="flex gap-4">
          <div
            class="w-[30px] h-[30px] rounded-full bg-[#66c0f4] text-[#1b2838] font-black text-sm font-display flex items-center justify-center shrink-0"
          >
            1
          </div>
          <div class="flex-1 min-w-0">
            ...
            <input
              ...
              :class="{
                'border-red-400': apiKey && !keyValid,
                'border-green-400': keyValid,
              }"
        ...
        <div class="flex gap-4">
          ...
          <div class="flex-1 min-w-0">
            ...
            <input
              ...
              :class="{
                'border-red-400': steamIdInput && !idValid,
                'border-green-400': idValid,
              }"
...
export default defineComponent({
  ...
  computed: {
    ...
    canConnect(): boolean {
      return this.keyValid && this.idValid;
    },
  },
  methods: {
    connect(): void {
